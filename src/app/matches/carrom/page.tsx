...
export default function Page() {
  ...
  useEffect(() => {
    fetchEventsBySport(setLiveEvents, "⭕ Carrom", "🟢 Live");
    fetchEventsBySport(setUpcomingEvents, "⭕ Carrom", "🔵 Not Started");
    fetchEventsBySport(setCompletedEvents, "⭕ Carrom", "✅ Completed");
  }, []);
  ...
  return (
    <div>
      <div className="w-full h-[200px]  relative bg-gray-600">
        <div className="absolute bottom-0 left-0 p-6 z-10 text-4xl md:text-5xl xl:text-6xl text-center flex justify-center items-center font-semibold shadow-lg">Carrom</div>
